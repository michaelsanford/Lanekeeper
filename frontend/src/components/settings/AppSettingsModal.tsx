                      ...
                      >
                        <div className="flex items-center justify-between gap-2">
                          <div className="flex items-center gap-2 min-w-0">
                            <span
                              className="font-semibold text-slate-100 text-sm truncate"
                              style={{ fontFamily: f.fontFamily }}
                            >
                              {f.name}
                            </span>
                            {f.category === 'dyslexic' && (
                              <span className="text-[10px] font-mono px-1.5 py-0.5 rounded border uppercase tracking-wider bg-emerald-950/70 text-emerald-400 border-emerald-800/60 shrink-0">
                                Accessibility
                              </span>
                            )}
                          </div>
                        ...
                        <div
                          className="text-xs text-slate-300 bg-slate-900/80 px-3 py-2 rounded-lg border border-slate-800/90 truncate font-normal"
                          style={{ fontFamily: f.fontFamily }}
                          title={f.sampleText}
                        >
                          {f.sampleText}
